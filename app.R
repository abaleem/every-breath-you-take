...
# Team Members: 
# Sai Krishnan, Praveen Chandrasekaran, Varsha Jayaraman, Abdullah Aleem
...
Yearlydata <- reactive({ read.csv(paste0("Annual/annual_aqi_by_county_",input$year,".csv")) })
...
data_shp <- st_read("Boundaries/county_geometry.shp", stringsAsFactors = FALSE)
